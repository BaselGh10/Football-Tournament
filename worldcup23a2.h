...
class world_cup_t {
private:
    shared_ptr<RankTree<Team,Team::CompareTeamByAbility>> allTeamsByAbility;
    shared_ptr<RankTree<Team,Team::CompareTeamByID>> allTeams;
    shared_ptr<UnionFindTeams> uniTeams;
